  ...
  return (
    <div className="w-full bg-offWhite-700 text-offWhite-100 h-16 flex px-8 flex-row items-center">
      {matches ? (
        ...
        >
          <Link href="/" aClasses="w-full h-full">
            <ButtonBase sx={{ p: "1rem" }} className="w-full h-full">
              <div className="text-xl">Home</div>
            </ButtonBase>
          </Link>
          <Link href="/anime" aClasses="w-full h-full">
            <ButtonBase sx={{ p: "1rem" }} className="w-full h-full">
              <div className="text-xl">Lists</div>
            </ButtonBase>
          </Link>
          <Link href="/seasonal" aClasses="w-full h-full">
            <ButtonBase sx={{ p: "1rem" }} className="w-full h-full p-4">
              <div className="text-xl">Seasonal</div>
            </ButtonBase>
          </Link>
        </nav>
      ) : (
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <Link href="/prefrences">
                ...
                >
                  <div className="text-offWhite-100 no-underline">
                    Prefrences
                  </div>
                </MenuItem>
              </Link>
