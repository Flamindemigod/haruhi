  ...
  return (
    <div className="w-full bg-offWhite-700 text-offWhite-100 flex p-8 flex-col sm:flex-row justify-between">
      ...
      <div>
        ...
        <div className="">
          <a
            className="text-offWhite-100 hover:underline focus:underline"
            href={"https://github.com/andradesavio9073/haruhi"}
          >
            Submit Bug Reports or Help contribute on Github <GitHub />
          </a>
        </div>
      </div>
    </div>
