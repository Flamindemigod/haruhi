...
import { DateSegment as DateSegmentProps, DateFieldState} from "@react-stately/datepicker";
export function DateSegment({ segment, state }: { segment: DateSegmentProps; state: DateFieldState }) {
