...
const Login = () => {
  ...
  return (
    <div className='fullscreen fixed inset-0 flex flex-col justify-center items-center drop-shadow-md object-cover'>
      <div className="container p-8 flex flex-col gap-4 justify-center items-center bg-neutral-800 bg-opacity-80 shadow-xl text-center">
